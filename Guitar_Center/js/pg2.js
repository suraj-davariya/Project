...
document.addEventListener('DOMContentLoaded', function(){
    ...
    var countryElementId = document.getElementById("countryID");
    var stateElementId = document.getElementById("stateID");

    /*-----------------EXPIRATION MONTH YEAR STARTS----------------------------- */
    ...
    (function populateDates(){
        ...
        function populateStates(){
            ...
            var selectedCountryIndex = document.getElementById( "countryID" ).selectedIndex;
